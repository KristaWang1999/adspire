...
## ✅ ACTION ITEMS SUMMARY — Monday Oct 7

> Auto-generated from meeting notes
...
|---|-------------|----------|----------|---------|
| 1 | Research competitor onboarding (Asana, Linear, ClickUp) | 🔴 High | Fri Oct 11 | Meeting 1 — activation OKR, need before sprint planning |
| 2 | Draft PRD for notification improvements | 🔴 High | Fri Oct 11 | Meeting 2 — Mike requested, ties to Q1/Q2 decision |
| 3 | Talk to customer success: notification ticket volume | 🟡 Medium | Tue Oct 8 | Meeting 2 — data needed for prioritization |
| 4 | Competitive analysis: how other tools handle notifications | 🟡 Medium | Tue Oct 15 | Meeting 2 |
| 5 | Write one-pager on template library (scope, goals, timeline) | 🔴 High | Fri Oct 11 | Meeting 3 — Sarah needs to prioritize Q1 vs Q2 |
| 6 | Gather data on activation drop-off (where do users abandon?) | 🔴 High | Thu Oct 10 | Meeting 3 — needed before sprint planning |
| 7 | Review Alex's mobile PRD | 🟡 Medium | Wed Oct 9 | Personal reminder |
| 8 | Investigate custom SSO request from enterprise customer | 🟡 Medium | Tue Oct 8 | Parking lot — customer success escalated |
| 9 | Research competitor "Motion" and their AI features | 🟢 Low | Fri Oct 11 | Parking lot |
| 10 | Pull data: activation funnel, notification tickets, feature requests, NPS | 🔴 High | Tue Oct 8 | Needed for multiple upcoming decisions |

#### 🎨 Jordan (Design)
| # | Action Item | Priority | Due Date | Context |
|---|-------------|----------|----------|---------|
| 1 | Wireframes for interactive onboarding tour concept | 🔴 High | Mon Oct 14 | Meeting 1 — Sarah wants activation improvement |
| 2 | Investigate contrast issues for user-uploaded images in dark mode | 🟡 Medium | Wed Oct 9 | Meeting 1 — before design review |
| 3 | Quick mockups for template selection UI | 🟡 Medium | Mon Oct 14 | Meeting 3 |
| 4 | Dark mode final mockups | 🔴 High | Wed Oct 9 | Design review scheduled Wed |

#### 👩‍💼 Sarah (Head of Product)
| # | Action Item | Priority | Due Date | Context |
|---|-------------|----------|----------|---------|
| 1 | Talk to customer success about activation blockers | 🔴 High | Tue Oct 8 | Meeting 1 — activation OKR at 45%, target 60% |
| 2 | Schedule API v2 roadmap discussion | 🟢 Low | Next week | Parking lot |

#### 🔧 Mike (CTO)
| # | Action Item | Priority | Due Date | Context |
|---|-------------|----------|----------|---------|
| 1 | Technical spec for notification improvements (arch, DB schema, migration) | 🔴 High | Fri Oct 11 | Meeting 2 — needed for Q1/Q2 go/no-go decision |
| 2 | Investigate performance regression in search | 🟡 Medium | Thu Oct 10 | Parking lot |

#### 📱 Alex (Mobile PM)
| # | Action Item | Priority | Due Date | Context |
|---|-------------|----------|----------|---------|
| 1 | Assess whether mobile app needs template support at launch (or can defer to Q2) | 🟡 Medium | Mon Oct 14 | Meeting 3 — affects scope and timeline |

#### ⚙️ Jamie (Eng Lead)
| # | Action Item | Priority | Due Date | Context |
|---|-------------|----------|----------|---------|
| 1 | Detailed technical estimate for template library | 🟡 Medium | Tue Oct 15 | Meeting 3 — needed for Q1/Q2 decision |
...
| Date | What |
|------|------|
| Tue Oct 8 | Customer interview (enterprise admin, Salesforce) |
| Wed Oct 9 | Design review — dark mode final mockups |
| Thu Oct 10 | Sprint planning |
| Fri Oct 11 | PRDs + one-pagers due (notifications, templates) |
| Fri Oct 11 | All-hands |
